...
class _ItemWidgetState extends State<ItemWidget> {
  ...
  Widget build(BuildContext context) {
    return Consumer<ChatMessageListProvider>(
              ...
              messageChat.type == TypeMessage.text
                  ...
                  ? Container(
                      ...
                      margin: EdgeInsets.only(
                          bottom: widget.isLastMessageRight(
                                  widget.index, provider.listMessage)
                              ? 20
                              : 10,
                          right: 10),
                      child: Text(
          ...
          return Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                Row(
                  children: <Widget>[
                    widget.isLastMessageLeft(widget.index, provider.listMessage)
                        ? Material(
                            borderRadius: const BorderRadius.all(
                              Radius.circular(18),
                            ),
